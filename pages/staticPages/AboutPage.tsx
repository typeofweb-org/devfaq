const AboutPage = () => (
  <article className="app-static-page">
    ...
    <p>
      DevFAQ.pl jest serwisem internetowym służącym do udostępniania i wymiany pytań rekrutacyjnych
      na stanowiska front-end developerów oraz inne pokrewne. Został stworzony przez programistów
      dla programistów, a jego celem jest wymiana wiedzy oraz możliwość przygotowania się do rozmów
      rekrutacyjnych.
    </p>
    ...
    <ul>
      ...
      <li>Jeśli dodajesz kod do pytania, zadbaj o poprawne formatowanie (spacje, wcięcia itp.).</li>
      <li>
